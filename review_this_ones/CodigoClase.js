...
// tsc -p tsconfig.json
var messageText = "mi primer mensaje de chat";
var messageText2 = "hi terri";
var numberSample = 66;
...
var numbers = [1, 2];
var bigNumbers = [300, 400];
// esto es un claro ejemplo de deestructuracion: 
// tan solo estamos creando mis objetos.
// pero estudiarlo mejor despues...
var foodChat = { name: 'exploración de recetas de comida', model: 'gpt-4', version: 3 };
var typescriptChat = { name: 'profesor de typescript', model: 'gpt-3.5-turbo', version: 5 };
...
function displayChat(chat) {
    console.log("Chat: ".concat(chat.name, ", Model: ").concat(chat.model));
}
